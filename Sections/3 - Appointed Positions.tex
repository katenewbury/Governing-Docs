...
\subsubsection{'Pitch Your Own Idea' Coordinator(s)}
\label{pitch-your-own-idea-coordinators}
The 'Pitch Your Own Idea' Coordinator(s) shall:

\begin{enumerate}
 \item 
 Propose a novel idea, event, or initiative that another appointed or elected position is not already responsible for on the MES.
\item 
Develop a plan to bring about their idea over the course of the academic year.
\item 
Take appropriate steps to fulfill their idea.
\item 
Report to the President, unless delegated to another VP.
\end{enumerate}
...
\begin{enumerate}
 ...
 \item
  ...
  \item 
  Director of First Year Council
  \item 
  'Pitch Your Own Idea' Coordinator(s)
\end{enumerate}
