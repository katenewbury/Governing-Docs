...
\begin{enumerate}
 ...
 \item
  ...
  The website should have an up to date repository of all MES documents (Constitution, Bylaws, meeting minutes, Plumbline, Frequency, Handbook, Reports, etc.) and event news.
 \item
  Website editing access will be limited to the President, MES Executive, Website Coordinator(s), and Infrastructure Technology Manager(s). Further access may be granted at the discretion of the VPI.
...
\begin{enumerate}
 \item
  The MES Office contains a computer, printer, several monitors, and stationary supply.
 \item
  The Gerald Hatch Centre Student Coordinator(s) is responsible for the installation and maintenance of office equipment.
 \item
...
from the Trailer Coordinator(s) and the VPI.
...
\begin{enumerate}
 ...
 \item
  The group booking the MES Trailer is responsible for cleaning up any mess left in or on the MES Trailer. Failure to do so may result in a \$50 fine, at the discretion of the Trailer Coordinator(s) and the VPI.
 \item
...
\begin{enumerate}
 ...
 \item
  No additional copies of the MES Trailer keys may be made, except by the Trailer Coordinator(s) with written permission from the MES Executive. If illegal copies are found, the offending party will be subject to loss of privileges or other punishment as recommended by the VPI.
\end{enumerate}

\subsubsection{Use of Trailer}
\label{use-of-trailer}
All borrowers of the MES Trailer must comply with the MES Trailer Usage
Guidelines and sign the MES Trailer Use Agreement and submit it to the
Trailer Coordinator(s).  % fix this lol - more references
...
council and MES student groups. The full list of equipment is
...
Only the President, VPI, DoO, and both of the Co-OCs shall have access to the basement storage room (JHE-195A). The Co-OCs shall return this key by the second Friday following Welcome Week.
...
\begin{enumerate}
 ...
 \item
  ...
  \begin{enumerate}
   \item
    The VPA will ensure that all MES members pay no more than 50\% per session, up to a limit of 7 coupons per student per academic term
   \item
    Only one coupon may be redeemed per session with a tutor. 
   \item
 ...
 \item
  ...
  \begin{enumerate}
   ...
   \item
    Must have received a grade of 9 or higher in a course to be able to qualify to be a tutor for that course
   \item
